...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Installing Required Packages...${cierre}" |pv -qL 45
sleep 1
...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Installing Of Metasploit-Frameword...${cierre}" |pv -qL 45
sleep 0.5
echo -e ""
sleep 1
echo -e ""
...
sleep 0.5
echo -e ""
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Preparing The Installation...${cierre}" |pv -qL 45
sleep 0.5
echo -e "${rojo}[${verde}*${rojo}]${bicolor} This Will Take A Few Minutes...${cierre}" |pv -qL 45
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Do Not Cancel The Installation...${cierre}" |pv -qL 45
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} This will take a few minutes...${cierre}" |pv -qL 45
sleep 1
apt update && apt upgrade -y
echo -e ""
echo -e ""
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Starting The Installation...${cierre}" |pv -qL 45
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Please Be Patient...${cierre}" |pv -qL 45
sleep 1
# Loading spinner
echo -e -n "${rojo}[${verde}*${rojo}]${bicolor} Loading.....${bicolor}" |pv -qL 45
...
sleep 0.5
echo -e "${cierre}"
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Dependencies wget, curl, zip tar, etc...${cierre}" |pv -qL 45
sleep 0.5
...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Fix Ruby BigDecimal...${cierre}" |pv -qL 45
...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Downloading The Script...${cierre}" |pv -qL 45
cd $PREFIX/opt
...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Installing Gems...${cierre}" |pv -qL 45
...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${bicolor} Supprssing Warning${cierre}" |pv -qL 45
...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}√${rojo}]${bicolor} MSF Installed v6.3.36-dev-9c02331.${cierre}" |pv -qL 45
sleep 1
echo -e "${rojo}[${verde}√${rojo}]${bicolor} Open The Console With: ${verde}msfconsole${cierre}" |pv -qL 45
