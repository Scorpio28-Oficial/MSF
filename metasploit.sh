...
echo -e ""
sleep 1
echo -e "${rojo}[${amarillo}*${rojo}]${verde} Installing Version 6.2.26 Of Metasploit-Frameword...${blanco}"
sleep 0.5
echo -e ""
sleep 1
echo -e ""
...
if [[ $replyme == 'y' ]];then
echo -e ""
echo -e "${rojo}[${amarillo}√${rojo}]${verde} MSF Version 6.2.26 Installed Correctly...${blanco}"
sleep 2
