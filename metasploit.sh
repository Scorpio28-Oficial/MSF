...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${verde} INSTALLING VERSION 6.2.14 OF METASPLOIT-FRAMEWORD...${blanco}"
sleep 0.5
echo -e ""
sleep 1
echo -e ""
...
echo -e "${verde}╚═╝     ╚═╝╚══════╝╚═╝"${blanco}
echo -e ""
echo -e "${rojo}[${verde}☆${rojo}]${blanco} ${rojo}[${verde}☆${rojo}]${blanco} ${rojo}[${verde}☆${rojo}]${blanco} INFORMATIC IN TERMUX / WHITE HACKS ${rojo}[${verde}☆${rojo}]${blanco} ${rojo}[${verde}☆${rojo}]${blanco} ${rojo}[${verde}☆${rojo}]${blanco}"
sleep 3
echo -e ""
...
echo -e ""
echo -e "${rojo}[${verde}*${rojo}]${blanco} Informatic in Termux / WHITE HACKS"
fi
