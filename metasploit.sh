...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${verde} installing version 6.2.8 of Metasploit-framework...${blanco}"
sleep 0.5
echo -e ""
sleep 1
echo -e ""
...
if [[ $replyme == 'y' ]];then
echo -e ""
echo -e "${rojo}[${verde}√${rojo}]${verde} Cheers! Metasploit v6.2.8 Has Been Installed...${blanco}"
sleep 2
